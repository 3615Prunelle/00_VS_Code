...
/*
Créé cette fonction pour push_swap, et les autres programmes qui ont besoin d'afficher une string sur
une autre sortie que 1 (fd 1 = sortie standard, qui était jusque là dans tous les write)
